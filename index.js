...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = ["628xxx@Uwiw_Bocah","55xxxxx"] // replace with your whatsapp number
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/UwiwBocah', donate)
            break
        case '!tts':
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '6285813566726@Uwiw_Bocah')
            break
        case '!ig':
        ...
        case '!mentionall':
            ...
            for (let i = 0; i < groupMem.length; i++) {
                hehe += '╠➥'
                hehe += ` @${groupMem[i].id.replace(/@Uwiw_Bocah/g, '')}\n`
            }
            hehe += '╚═〘 Uwiw Bocah BOT 〙'
